...
<?php
session_start();
$_SESSION['user_id'] = $user_id; // Assurez-vous que cette ligne est bien présente après l'authentification
?>

var_dump($_SESSION); // Affiche tout ce qui est stocké dans la session

<?php
session_start();  // Démarre la session ou la reprend si déjà démarrée

// Vérifiez si l'utilisateur est connecté avant d'exécuter le code
...
<header>
    <div class="navbar">
        <ul class="links">
            ...
            <li>
                <a href="<?php echo isset($_SESSION['user_id']) && $_SESSION['user_id'] !== null ? './pages/ajouter_commentaire.php' : './pages/connexion.php'; ?>">
    ...
    <div class="page">
        ...
        <div class="boxe">
            <div class="book_card">
                ...
                <form action="<?php echo isset($_SESSION['user_id']) && $_SESSION['user_id'] !== null ? './pages/ajouter_commentaire.php' : './pages/connexion.php'; ?>" method="post">
                    <input type="submit" value="Ajouter un commentaire" class="btn" style="height:50px; width:120px">
                </form>
            </div>
        </div>

        <div class="recent">
            <h2>Témoignages récents</h2><br>

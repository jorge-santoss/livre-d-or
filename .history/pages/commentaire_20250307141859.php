...
if (isset($_SESSION['id'])) {
    echo "User is logged in. User ID: " . $_SESSION['usid'];
} else {
                    ...
                    <div class="table_comment">
                        <div class="text_comment">
                            ...
                            <div>
                                ...
                                <input type="text" id="id_user" name="id_user" maxlength="30" size="46" value="<?php if (isset($_POST['id_user'])) echo htmlentities(trim($_POST['id_user'])); ?>">
                            </div>
                            <br>
                            <div>

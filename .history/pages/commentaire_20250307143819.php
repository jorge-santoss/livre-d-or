...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['go']) && $_POST['go'] == 'Signer') {
    if (isset($_SESSION['id'])) {
        ...
        if (!empty($id_user) && !empty($comment) && !empty($date)) {
            if ($commentObj->addComment($user_i, $comment, $date)) {
                    ...
                    <div class="table_comment">
                        <div class="text_comment">
                            ...
                            <div>
                                ...
                                <input type="text" id="user_id" name="user_id" maxlength="30" size="46" value="<?php if (isset($_POST['id_user'])) echo htmlentities(trim($_POST['id_user'])); ?>">
                            </div>
                            <br>
                            <div>

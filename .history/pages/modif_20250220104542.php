        ...
        if (empty($message)) {
            ...
            if ($userObj->userExistsExcludingCurrent($nom, $email, $user_id)) {
                ...
                if ($updatePassword) {
                    ...
                    $password_hashed = $currentUser['password'];
                }
        ...
        <div class="livre_card">
            <form action="modif.php" method="post">
                ...
                <div class="text_area">
                    ...
                    <input type="text" id="nom" name="nom" placeholder="Nom" value="<?php echo htmlspecialchars($currentUser['nom']); ?>"><br>

                    <label for="email">Email</label>
                    <input type="email" id="email" name="email" placeholder="Email" value="<?php echo htmlspecialchars($currentUser['email']); ?>"><br>

    ...
    if (isset($_POST['nom']) && isset($_POST['password']) && isset($_POST['email']) && isset($_POST['confirm_password'])) {
        ...
        if (empty($message)) {
            ...
            if ($user->userExists($nom, $email)) {
                ...
                header("Location: ./pages/connexion.php"); // Rediriger après inscription réussie
                exit();
            }
        }
    }
                    ...
                    <div class="livre_form">
                        <div class="livre_card">
                            <div class="text_area">
                                ...
                                <p class="./pages/connexion"> "Avez vous déjà un compte?"
                                    <br><a href="./pages/connexion.php">Connexion</a>
                                </p>
                            </div>
                        </div>
